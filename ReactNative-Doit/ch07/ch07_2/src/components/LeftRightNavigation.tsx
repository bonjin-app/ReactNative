import { forwardRef, ForwardRefRenderFunction, MutableRefObject, ReactNode, useImperativeHandle, useState } from "react"
...
const _LeftRightNavigation: ForwardRefRenderFunction<LeftRightNavigationMethods, LeftRightNavigationProps> = (
