...
import { useAnimatedValue, useAnimatedValues, useStyle, useToggle, useTransformStyle } from '../hooks'
  ...
  return (
    <Animated.View style={[styles.view, enterLeaveTransformStyle]}>
      ...
      <View style={[styles.rightView]}>
        ...
        <Animated.Image style={[styles.image, fadeInOutStyle, topOrBottomTransformStyle]} source={{uri: person.image}} />
